...
- [impacket-qa](impacket-qa.md) : Configure GOAD hosts for Impacket regression testing
- [impacket-legacy](impacket-legacy.md) : Add optional legacy Windows targets for Impacket compatibility testing
